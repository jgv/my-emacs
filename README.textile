...
* Don't forget to byte compile js2-mode on your own machine @emacs --batch --eval '(byte-compile-file "~/.emacs.d/vendor/js2/js2.el")'@

h2. Why?

* <code>git clone https://jgv@github.com/jgv/my-emacs.git</code> and I'm home.
